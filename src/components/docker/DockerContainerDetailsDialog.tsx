...
import { DockerDetailsActionsPanel } from "@/components/docker/atoms/DockerDetailsActionsPanel";
import { DockerDetailsSummary } from "@/components/docker/atoms/DockerDetailsSummary";
import { DockerLogsPanel } from "@/components/docker/atoms/DockerLogsPanel";
import { DockerProcessCards } from "@/components/docker/DockerProcessCards";
...
export function DockerContainerDetailsDialog({
  ...
  return createPortal(
    ...
    >
      <div
        className="file-dialog file-dialog--docker-details"
        role="dialog"
        aria-modal="true"
      ...
      >
        <header className="file-dialog__header">
          <div className="file-dialog__heading">
            ...
            <p className="file-dialog__path">{openId}</p>
          </div>
        ...
        >
          ...
          {showDetailsContent && activeTab === "summary" ? (
            <DockerDetailsSummary details={details} />
          ) : null}
          ...
          {showDetailsContent && activeTab === "logs" ? (
            <DockerLogsPanel containerId={openId} />
          ) : null}
